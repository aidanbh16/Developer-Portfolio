            ...
            <main className="w-3/4 h-full flex">
                <div className="w-1/2 h-full flex flex-col justify-center">
                    <div className={`w-full h-2/5 px-10 flex flex-col justify-center gap-y-5 bg-black/85 border-white border-3 shadow-lg rounded-[35px] ${style.float}`}>
                        ...
                        <div>
                            <h2 className="text-2xl">SQL Developer Intern @ UNG</h2>
                            <h3 className="text-xl">Computer Science Major / Machine Learning Minor</h3>
                        </div>
                        ...
                        <h4 className="text-lg">Based in Atlanta</h4>
                    </div>
                </div>
            </main>
        </section>
